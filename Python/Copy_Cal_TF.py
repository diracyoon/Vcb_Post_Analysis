...
parser.add_argument('-a', dest='Analyzer', default="Vcb_Cal_TF")
...
if args.mc == True:
    ...
    for mc in mc_list:
        ...
        src = f"/gv0/Users/isyoon/SKFlatOutput/Run2UltraLegacy_v3/{args.Analyzer}/{args.Era}/RunNoJESBreakdown__/{args.Analyzer}_{mc}.root"
