...
Result_Event::Result_Event(const TString &a_era, const TString &a_channel, const TString &a_analyser, const TString &a_swap_mode) : W_Event(a_era, a_channel, a_swap_mode)
{
  analyser = a_analyser;
