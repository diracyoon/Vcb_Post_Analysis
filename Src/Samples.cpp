...
Samples::Samples(const TString &a_era, const TString &a_channel, const TString &a_analyser)
{
  ...
  if (era == "2018")
  {
    ...
    {
      map_data["EGamma_A"] = "Vcb_EGamma_A.root";
      map_data["EGamma_B"] = "Vcb_EGamma_B.root";
      map_data["EGamma_C"] = "Vcb_EGamma_C.root";
      map_data["EGamma_D"] = "Vcb_EGamma_D.root";

      map_short_name_data["EGamma_A"] = "EGamma";
      map_short_name_data["EGamma_B"] = "EGamma";
      map_short_name_data["EGamma_C"] = "EGamma";
      map_short_name_data["EGamma_D"] = "EGamma";
    } // else if(channel=="El")
    else if (channel == "MM" || channel == "EE" || channel == "ME")
    {
      map_data["SingleMuon_A"] = "Vcb_SingleMuon_A.root";
      map_data["SingleMuon_B"] = "Vcb_SingleMuon_B.root";
      map_data["SingleMuon_C"] = "Vcb_SingleMuon_C.root";
